...
<html lang="en">
	<head>
		...
		<title>Ellestmanuelle | Administration themes</title>
	</head>
	<body>
		<?php
			include_once('../dal/AdminRepository.php');
			$repo = new AdminRepository();			
			$themes = $repo->getAllRecords('theme', '*', '', 'ORDER BY id DESC');
		?>
			<div class="container">
			<div class="card">
				<div class="card-header">
					<i class="fa fa-fw fa-globe"></i><strong>Browse Themes</strong> 
					<a href="/admin/index.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-arrow-circle-left"></i> Return to admin</a>
					<a href="add.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Theme</a>
				</div>
				<div class="card-body">
					<?php
					...
					<tbody>
						...
						<tr>
							...
							<td align="center">
								...
								<a href="delete.php?delId=<?php echo $theme['id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this theme?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
							</td>
