<?php 
	...
	if (isset($_REQUEST['submit']) && $_REQUEST['submit'] != "")
	{
		...
		{
			header('location:'.$_SERVER['PHP_SELF'].'?msg=uk');
			exit;
		}
...
<html lang="en">
	<head>
		...
		<title>Ellestmanuelle | Administration technique</title>
  	</head>
  	<body>
		<div class="container">
			<?php
			...
			<div class="card">
				<div class="card-header">
					<i class="fa fa-fw fa-plus-circle"></i> <strong>Add Technique</strong> 
