...
<html lang="en">
	...
	<body>
		<?php
			...
			$techniques = $repo->getAllRecords('technique', '*', '', 'ORDER BY id DESC');
		?>
			<div class="container">
			<div class="card">
				<div class="card-header">
					<i class="fa fa-fw fa-globe"></i><strong>Browse Techniques</strong> 
					<a href="/admin/index.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-arrow-circle-left"></i> Return to admin</a>
					<a href="add.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Technique</a>
				</div>
				<div class="card-body">
					<?php
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td align="center">
								<a href="edit.php?editId=<?php echo $technique['id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
								<a href="delete.php?delId=<?php echo $technique['id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this technique?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
							</td>
