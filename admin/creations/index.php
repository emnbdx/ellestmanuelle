...
<body>
	...
	$userData	=	$db->getAllRecords('creation','*',$condition,'ORDER BY id DESC');
	?>
   	<div class="container">
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Creations</strong> <a href="add-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Creations</a></div>
			<div class="card-body">
				<?php
